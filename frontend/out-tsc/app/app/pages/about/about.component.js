...
function AboutPageComponent_Conditional_2_For_2_Template(rf, ctx) { if (rf & 1) {
...
function AboutPageComponent_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 2);
    i0.ɵɵrepeaterCreate(1, AboutPageComponent_Conditional_2_For_2_Template, 1, 3, "elide-metric-card", 4, _forTrack0);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function AboutPageComponent_Conditional_3_For_2_Template(rf, ctx) { if (rf & 1) {
...
function AboutPageComponent_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 3);
    i0.ɵɵrepeaterCreate(1, AboutPageComponent_Conditional_3_For_2_Template, 7, 4, "a", 5, _forTrack1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
...
function AboutPageComponent_Conditional_4_For_2_Conditional_7_Template(rf, ctx) { if (rf & 1) {
...
function AboutPageComponent_Conditional_4_For_2_Conditional_8_Template(rf, ctx) { if (rf & 1) {
...
function AboutPageComponent_Conditional_4_For_2_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(7, AboutPageComponent_Conditional_4_For_2_Conditional_7_Template, 2, 1, "small");
    i0.ɵɵconditionalCreate(8, AboutPageComponent_Conditional_4_For_2_Conditional_8_Template, 2, 1, "button", 7);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function AboutPageComponent_Conditional_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "div", 3);
    i0.ɵɵrepeaterCreate(1, AboutPageComponent_Conditional_4_For_2_Template, 9, 5, "article", 6, _forTrack2);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
...
export class AboutPageComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: AboutPageComponent, selectors: [["about-page"]], decls: 5, vars: 9, consts: [[1, "elide-section"], [3, "eyebrow", "title", "description", "actionLabel", "actionIcon", "actionLink"], [1, "metric-grid"], [1, "action-grid"], [3, "label", "value", "icon"], [1, "feature-card", 3, "routerLink"], [1, "feature-card"], ["mat-button", "", "type", "button"]], template: function AboutPageComponent_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "section", 0);
            i0.ɵɵelement(1, "elide-client-heading", 1);
            i0.ɵɵconditionalCreate(2, AboutPageComponent_Conditional_2_Template, 3, 0, "div", 2);
            i0.ɵɵconditionalCreate(3, AboutPageComponent_Conditional_3_Template, 3, 0, "div", 3);
            i0.ɵɵconditionalCreate(4, AboutPageComponent_Conditional_4_Template, 3, 0, "div", 3);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance();
